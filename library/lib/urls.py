...
urlpatterns=[
    ...
    path('readers/profile/edit/', views.edit_profile, name='edit_profile'),
    path('readers/profile/', views.reader_profile, name='reader_profile'),
    path('readers/profile/change-password/', views.change_password, name='change_password'),
    ...
    path('admin/profile/change-password/', views.change_admin_password, name='change_admin_password'),
